package cc.easyandroid.settingview.setting;
...
public abstract class RowView extends LinearLayout implements OnClickListener, OnSharedPreferenceChangeListener {
    ...
    protected float getPersistedFloat(float defaultReturnValue) {
        ...
        return sharedPreferences.getFloat(mKey, defaultReturnValue);
    }
    ...
    protected float getPersistedLong(long defaultReturnValue) {
        ...
        return sharedPreferences.getLong(mKey, defaultReturnValue);
    }
